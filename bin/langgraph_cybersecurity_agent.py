...
# ============================================================================
# WORKFLOW TEMPLATE MANAGER (REMOVED - NOW USING UNIFIED MANAGER)
# ============================================================================
# The old WorkflowTemplateManager class has been removed and replaced with
# the UnifiedWorkflowTemplateManager from bin/unified_workflow_template_manager.py
# This provides a single source of truth for all workflow templates.
...
class LangGraphCybersecurityAgent:
    ...
    def __init__(self):
        ...
        # Initialize unified workflow template manager
        from bin.unified_workflow_template_manager import UnifiedWorkflowTemplateManager
        self.workflow_manager = UnifiedWorkflowTemplateManager()
